function answerQuizz() {
  ...
  const inputElementZero = document.querySelector('.math-perimeter-input-zero');
  ...
  // Quiz 2
  const inputElementOne = document.querySelector('.math-perimeter-input-one');
  ...
  const inputElementTwo = document.querySelector('.math-perimeter-input-two');
  ...
  // Quiz 4
  const inputElementThree = document.querySelector('.math-perimeter-input-three');
  ...
  // Quiz 5
  const inputElementFour = document.querySelector('.math-perimeter-input-four');
