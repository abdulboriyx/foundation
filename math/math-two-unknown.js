function answerQuizz() {
  ...
  const inputElementZero = document.querySelector('.math-two-unknown-input-zero');
  ...
  // Quiz 2
  const inputElementOne = document.querySelector('.math-two-unknown-input-one');
  ...
  const inputElementTwo = document.querySelector('.math-two-unknown-input-two');
  ...
  // Quiz 4
  const inputElementThree = document.querySelector('.math-two-unknown-input-three');
  const valueInputThree = inputElementThree.value;

  if (valueInputThree === '1900') {
  ...
  // Quiz 5
  const inputElementFour = document.querySelector('.math-two-unknown-input-four');
