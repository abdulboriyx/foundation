function answerQuizz() {
  ...
  const inputElementZero = document.querySelector('.math-geometry-input-zero');
  ...
  // Quiz 2
  const inputElementOne = document.querySelector('.math-geometry-input-one');
  ...
  const inputElementTwo = document.querySelector('.math-geometry-input-two');
  ...
  // Quiz 4
  const inputElementThree = document.querySelector('.math-geometry-input-three');
  ...
  // Quiz 5
  const inputElementFour = document.querySelector('.math-geometry-input-four');
