function answerQuizz() {
  ...
  const inputElementZero = document.querySelector('.math-measurement-input-zero');
  ...
  // Quiz 2
  const inputElementOne = document.querySelector('.math-measurement-input-one');
  ...
  const inputElementTwo = document.querySelector('.math-measurement-input-two');
  ...
  // Quiz 4
  const inputElementThree = document.querySelector('.math-measurement-input-three');
  ...
  // Quiz 5
  const inputElementFour = document.querySelector('.math-measurement-input-four');
